...
public class CFLang extends Lang {

    /**
     * legacy-ish. Use CFLang.translate and other builder methods where possible
     */
    public static MutableComponent translateDirect(String key, Object... args) {
        Object[] args1 = LangBuilder.resolveBuilders(args);
        return Component.translatable(CreateFrequency.MODID + "." + key, args1);
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(CreateFrequency.MODID);
    }
